...
**`平时练习及考试`** 文件夹收录了大量的实战题目，记录了日常刷题和备考的过程：
- **校内考试**：杭州师范大学（HNU）程序设计基础课程的月考、期末考、补考及多校联考真题。
...
## 🌟 仓库亮点
- **全面性**：覆盖了大学C语言课程从入门到进阶的全过程。
- **实战性**：包含大量真实的考试题目和OJ判题代码。
- **趣味性**：通过贪吃蛇、2048等游戏项目激发编程兴趣。

---
*Created by Guide & Copilot*
